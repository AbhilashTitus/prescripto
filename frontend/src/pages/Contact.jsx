...
const Contact = () => {
  return (
    <div className="max-w-4xl mx-auto p-8 space-y-8 bg-white rounded-lg shadow-lg mt-8">
      {/* Contact Header */}
      <h1 className="text-3xl font-semibold text-gray-800 text-center">Get in Touch</h1>
      <p className="text-lg text-gray-600 text-center">We’re here to help. Whether you have a question, feedback, or need support, feel free to reach out to us.</p>
      ...
      <div className="p-6 bg-gray-50 rounded-lg shadow">
        ...
        <p className="text-gray-600 mt-2">Your feedback helps us improve our service. Please let us know your thoughts below.</p>
        ...
        <form className="mt-6 space-y-4">
          ...
          <textarea placeholder="Your Message" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 h-32"></textarea>
          <button type="submit" className="w-full bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-200">Send Message</button>
        </form>
      </div>
    </div>
  )
